...
## Sovelluksen tavoitteet
  ...
  * Käyttäjä voi tarkastella sovellukseen lisättyjä omia sekä ilmoituksia. Käyttäjä näkee sekä itse lisäämänsä että muiden käyttäjien julkaisemat ilmoitukset.
